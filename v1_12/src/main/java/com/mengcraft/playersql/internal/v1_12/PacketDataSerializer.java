package com.mengcraft.playersql.internal.v1_12;
...
public class PacketDataSerializer implements IPacketDataSerializer {
    ...
    private final net.minecraft.server.v1_12_R1.PacketDataSerializer buf;

    @SneakyThrows
    public PacketDataSerializer(ByteBuf bytebuf) {
        buf = new net.minecraft.server.v1_12_R1.PacketDataSerializer(bytebuf);
    }
    ...
    public void write(ItemStack input) {
        ...
        net.minecraft.server.v1_12_R1.ItemStack nms = (net.minecraft.server.v1_12_R1.ItemStack) handle.get(item);
        buf.a(nms);
    }
